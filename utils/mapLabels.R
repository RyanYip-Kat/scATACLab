...
projHeme=addCellColData(ArchRProj=projHeme,data=clusters,name=args$name,cells=rownames(metadata),force = TRUE)
saveRDS(projHeme,file.path(getOutputDirectory(projHeme),"Save-ArchR-Project.rds"))
