...
projHeme=addCellColData(projHeme,data=DATA$barcode,cells =DATA$cells, name = "Barcode")
if("status"%in%colnames(DATA)){
	projHeme=addCellColData(projHeme,data=DATA$status,cells =DATA$cells, name = "Status")
}
