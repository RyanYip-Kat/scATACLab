...
parser$add_argument("--gtf",
                    type="character",
                    default="/home/ye/Data/10X/VDJ/ref/refdata-cellranger-mm10-3.0.0/genes/genes.gtf",
                    help="gene.gtf file")
...
message("INFO : loading gene gtf annotation ...")
tssWindow <- 2500
genes.gr=getGeneGTF(gtfFile) 
mcols(genes.gr)$name=mcols(genes.gr)$gene_name
