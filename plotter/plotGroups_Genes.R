...
markers=as.character(read.table(args$marker,stringsAsFactors=F,header=F)$V1)
all.genes=getFeatures(projHeme,useMatrix=args$slot)
markers=markers[markers%in%all.genes]
